...
func setOpt54And60AndSNAME(opt60FromClient string, tftp net.IP, http net.IP) (dhcpv4.Modifier, option.ClientType) {
	opt54 := tftp
	opt60 := option.PXEClient
	if strings.HasPrefix(opt60FromClient, string(option.HTTPClient)) {
		opt54 = http
